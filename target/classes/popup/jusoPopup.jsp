...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDI1MDExNDEzMDY0MzExNTQwMzE=";
...
<body onload="init();">
	<form id="form" name="form" method="post">
		...
		<input type="hidden" id="roadAddrPart1" name="roadAddrPart1" value=""/>
		<input type="hidden" id="addrDetail" name="addrDetail" value=""/>
		<input type="hidden" id="roadAddrPart2" name="roadAddrPart2" value=""/>
