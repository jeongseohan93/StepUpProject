...
public class StepupVO {
	...
	private String academy_id,academy_pwd,academy_name,academy_phone,academy_content,
	academy_bus_num,academy_address,academy_latitude,academy_longitude,
	academy_category,academy_sub,academy_email,academy_profile,
	academy_photo1,academy_photo2,academy_photo3,academy_photo4,academy_photo5;
	...
	public String getAcademy_photo1() {
		return academy_photo1;
	}

	public void setAcademy_photo1(String academy_photo1) {
		this.academy_photo1 = academy_photo1;
	}

	public String getAcademy_photo2() {
		return academy_photo2;
	}

	public void setAcademy_photo2(String academy_photo2) {
		this.academy_photo2 = academy_photo2;
	}

	public String getAcademy_photo3() {
		return academy_photo3;
	}

	public void setAcademy_photo3(String academy_photo3) {
		this.academy_photo3 = academy_photo3;
	}

	public String getAcademy_photo4() {
		return academy_photo4;
	}

	public void setAcademy_photo4(String academy_photo4) {
		this.academy_photo4 = academy_photo4;
	}

	public String getAcademy_photo5() {
		return academy_photo5;
	}

	public void setAcademy_photo5(String academy_photo5) {
		this.academy_photo5 = academy_photo5;
	}
